...
func TestSetup_RegistersP5Routes(t *testing.T) {
	...
	engine := Setup(authSvc, jwtSvc, agentRouter, agentCfgH, nil, schedTaskH, noteH, taskSettingsH, goalSettingsH, agentPrefsH, nil, nil, logH, nil, nil, nil, nil, nil, nil, nil, nil, nil, skillsCfg, commandsCfg, rulesCfg, config.SubAgentsConfig{}, config.SelectorConfig{}, gin.TestMode, "", false, true)
